...
/**
 * ProofState as returned by PVS
 */
export type PvsProofState = {
	id?                  : string,       // proof id
	"unique-ps-id"?      : string,       // proof-state id (unique in the given proof)
	"display-id"?        : string,       // proof-state id (for displaying purposes)
	"parent-display-id"? : string,       // display id of the parent of this proof state
	"children"?          : string[],     // display ids of the children of this proof state
	path?                : string,       // unique identifier representing the current position in the proof tree, e.g., 1.2.1
	label                : string,       // sequent label
	...
	"prev-cmd"?         : string;        // command that generated the 'sequent'
	"curr-cmd"?         : string;        // command applied on 'sequent'
	...
	status?         : string             // Status as defined in PVS: 
																			 // - '!' closed branch;
