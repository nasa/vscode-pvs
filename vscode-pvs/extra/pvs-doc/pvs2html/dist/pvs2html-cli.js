...
const pvs2html_1 = require("./pvs2html");
// help message
...
function generateDocFiles() {
    return __awaiter(this, void 0, void 0, function* () {
        const worker = new pvs2html_1.Pvs2Html();
        console.log(process.argv);
        const options = parseCliArgs(process.argv.slice(2));
        if (options === null || options === void 0 ? void 0 : options.inputFolder) {
            const desc = yield worker.run(options); // the first two args are 'node' and 'pvs2html.js'
...
generateDocFiles();
//# sourceMappingURL=pvs2html-cli.js.map